...
def main():
    ...
    pages = [
        ("_01_Monitoreo_Aduanas.py", 36, "Borde izquierdo azul", "#0066cc"),
        ("_02_Flujos_de_Carga.py", 4, "Borde superior azul", "#1976d2"),
    ...
    colors = [
        ("#0066cc", "Azul Brillante (Primario)"),
        ("#1976d2", "Azul Corporativo"),
        ("#0052a3", "Azul Secundario"),
        ("#003d7a", "Azul Muy Oscuro"),
