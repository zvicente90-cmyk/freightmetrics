...
def page_indice_freightmetrics():
    ...
    with col1:
        st.markdown(f"""
            <div style='background: linear-gradient(135deg, #29B5E8 0%, #2196F3 100%); 
                        color: white; 
                        padding: 25px; 
                        border-radius: 12px;
    ...
    with col_comp1:
        ...
        fig_componentes = go.Figure(data=[go.Bar(
            ...
            marker_color=['#29B5E8', '#29B5E8', '#4CAF50', '#FFA726'],
    ...
    with col_front1:
        st.markdown(f"""
            <div style='background-color: #E8F5E9; border-left: 5px solid #4CAF50; padding: 20px; border-radius: 10px;'>
                ...
                <p style='font-size: 2rem; font-weight: 700; color: #F4F7F6; margin: 0;'>{indice_mexico:.2f}</p>
    ...
    with col_front2:
        st.markdown(f"""
            <div style='background-color: #E3F2FD; border-left: 5px solid #2196F3; padding: 20px; border-radius: 10px;'>
                ...
                <p style='font-size: 2rem; font-weight: 700; color: #F4F7F6; margin: 0;'>{indice_canada:.2f}</p>
                <p style='color: #666; margin: 5px 0 0 0;'>
    ...
    with col_front3:
        st.markdown(f"""
            <div style='background-color: #FFF3E0; border-left: 5px solid #FFA726; padding: 20px; border-radius: 10px;'>
                ...
                <p style='font-size: 2rem; font-weight: 700; color: #F4F7F6; margin: 0;'>{abs(indice_mexico - indice_canada):.2f}</p>
    ...
    with col_ins1:
        ...
        st.markdown(f"""
            <div style='background-color: {tendencia_color}20; border-left: 5px solid {tendencia_color}; padding: 20px; border-radius: 10px;'>
                ...
                <p style='color: #F4F7F6; margin: 0; line-height: 1.6;'>{tendencia_msg}</p>
            </div>
        """, unsafe_allow_html=True)
    ...
    with col_ins2:
        ...
        st.markdown(f"""
            <div style='background-color: {vol_color}20; border-left: 5px solid {vol_color}; padding: 20px; border-radius: 10px;'>
                ...
                <p style='color: #F4F7F6; margin: 0; line-height: 1.6;'>{vol_msg}</p>
            </div>
        """, unsafe_allow_html=True)
