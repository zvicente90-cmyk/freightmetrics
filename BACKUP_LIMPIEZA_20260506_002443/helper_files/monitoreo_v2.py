...
def page_monitoreo_v2():
    ...
    if 'México' in stats and 'Canadá' in stats:
        ...
        with col_c2:
            st.markdown("""
                <div style='background: linear-gradient(135deg, #2196F3 0%, #131b2e 100%); 
                            color: white; 
                            padding: 20px; 
                            border-radius: 12px;
                    ...
                    for insight in advertencias:
                        ...
                        st.markdown(f"""
                            <div style='background-color: #FFF3E0; 
                                ...
                                <p style='color: #F4F7F6; margin: 5px 0; font-size: 0.9rem;'>{insight['mensaje']}</p>
                    ...
                    for insight in oportunidades:
                        st.markdown(f"""
                            <div style='background-color: #E8F5E9; 
                                ...
                                <p style='color: #F4F7F6; margin: 3px 0; font-size: 0.85rem;'>{insight['mensaje']}</p>
    ...
    with col_t1:
        st.markdown(f"""
            <div style='background-color: {color}20; 
                ...
                <p style='color: #F4F7F6; margin: 0; font-size: 0.9rem;'>{desc}</p>
            </div>
        """, unsafe_allow_html=True)
    ...
    with col_t2:
        ...
        st.markdown(f"""
            <div style='background-color: #F5F5F5; 
                        ...
                        border-radius: 8px;
                        margin: 10px 0;'>
                <h4 style='color: #F4F7F6; margin: 0 0 8px 0;'>📊 Progreso del Día</h4>
                <p style='color: #F4F7F6; margin: 0; font-size: 0.9rem;'>Completado: {progreso:.1f}%</p>
            </div>
        """, unsafe_allow_html=True)
        ...
        if hora_actual_grafico < 20:
            ...
            st.markdown(f"""
                <div style='background-color: #E3F2FD; 
                            ...
                            border-radius: 8px;
                            margin: 10px 0;'>
                    <h4 style='color: #131b2e; margin: 0 0 8px 0;'>⏱️ Hora Pico</h4>
                    <p style='color: #F4F7F6; margin: 0; font-size: 0.9rem;'>{horas_restantes}h restantes</p>
                </div>
            """, unsafe_allow_html=True)
        else:
            st.markdown(f"""
                <div style='background-color: #E8F5E9; 
                    ...
                    <p style='color: #F4F7F6; margin: 0; font-size: 0.9rem;'>Finalizada</p>
                </div>
            """, unsafe_allow_html=True)
    ...
    st.markdown(f"""
        <div style='background: linear-gradient(135deg, #F4F7F6 0%, {color_estado} 100%); 
                    color: white; 
                    padding: 25px; 
                    border-radius: 15px;
            ...
            for i, rec in enumerate(recomendaciones[:3], 1):
                st.markdown(f"""
                    <div style='background-color: #F5F5F5; 
                        ...
                        <p style='margin: 0; color: #F4F7F6; font-size: 0.85rem;'>
