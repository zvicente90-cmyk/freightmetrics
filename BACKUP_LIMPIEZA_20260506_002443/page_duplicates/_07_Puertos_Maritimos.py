...
def page_puertos_maritimos():
    ...
    # ============ HEADER PRINCIPAL ============
    st.markdown("""
        <div style='background: linear-gradient(135deg, #0b1326 0%, #1a2d4a 100%); 
                    color: white; 
                    padding: 50px 60px; 
                    border-radius: 20px; 
                    margin-bottom: 40px;
    ...
    # ============ DESCRIPCIÓN GENERAL ============
    st.markdown("""
        <div style='background: linear-gradient(135deg, rgba(41, 181, 232, 0.15) 0%, rgba(25, 118, 210, 0.08) 100%); 
                    padding: 35px 40px; 
                    border-radius: 15px; 
                    border-left: 6px solid #1a2d4a;
                    margin-bottom: 50px;'>
            <p style='color: #0b1326; font-size: 1.05rem; margin: 0; line-height: 1.8; font-weight: 500;'>
