...
def page_fuerza_laboral():
    ...
    data_laboral = {
        ...
        'Vacantes_Activas': [
            2595, 10645, 599, 732, 1497, 9314,
            8316, 6154, 931, 1730, 16966, 5489,
            1264, 2262, 7984, 3060, 1397, 931, 14970, 1264,
            6054, 6321, 1397, 3659, 4258, 5822, 1597,
            12641, 1497, 5589, 1929, 1264
        ],
        'Deficit_Operadores': [
            1730, 6986, 399, 499, 931, 6154,
            5489, 4058, 599, 1131, 11310, 3593,
            832, 1497, 5256, 2029, 931, 599, 9913, 832,
            3992, 4158, 931, 2395, 2794, 3826, 1065,
            8317, 998, 3659, 1264, 832
        ],
        'Sueldo_Promedio_MX': [
    ...
    data_cruce = {
        ...
        'Parque_Vehicular': [
            21623, 123084, 7319, 9980, 28276, 129737,
            139717, 93145, 13306, 31603, 282761, 96471,
            23952, 39919, 139717, 56552, 23286, 18296, 206249, 23286,
            126411, 79838, 21623, 66532, 76512, 89818, 26613,
            192943, 24950, 103125, 33266, 21623
        ],
